...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMatKhau.setText("Tạo mật khẩu");
        ...
        ivCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(soLanDangNhap == 0){
                    customToast("Đăng ký thành công!",true);
                    savePrefs(edtMatKhau.getText().toString(),1);
                    Intent intent = new Intent(LoginActivity.this,MainActivity.class);
                    startActivity(intent);
                }else if(soLanDangNhap == 1){
                    if(edtMatKhau.getText().toString().equals(matKhau)){
                        customToast("Đăng nhập thành công!",true);
                        savePrefs(edtMatKhau.getText().toString(),1);
                        Intent intent = new Intent(LoginActivity.this,MainActivity.class);
                        startActivity(intent);
                    }else{
                        customToast("Đăng nhập thất bại!",false);
                    }
                }
            }
        });
